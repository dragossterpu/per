...
public class ParseHtml4 {
    ...
    public static final String DEST_PDF = "C:\\informes\\informe_prueba.pdf";
    
    public static final String DEST_DOC = "C:\\informes\\informe_prueba.doc";
    
    public static void main(String[] args) {
        // File file = new File(DEST_PDF);
        // file.getParentFile().mkdirs();
        // new ParseHtml4().createPdf(DEST_PDF);
        // tidyUp();
        
        try {
            new ParseHtml4().createPDFtoDoc();
        } catch (IOException e) {
    ...
    public void createPdf(String file) throws IOException, DocumentException {
        String str = "<html><head><title>Test PDF</title></head><body><div>"
                ...
                + "</div><div><p class=\"paddingSilvia\">Padding Silvia</p><p>Sin padding</p></div></body></html>";
        ...
        CssFile cssTextEditor = XMLWorkerHelper.getCSS(getCSSInputStream("/static/css/texteditor.css"));
    ...
    public void createDoc(File file) throws Exception {
        String xhtml = "<html><head><title>Test PDF</title></head><body><div>"
                + "<img src=\"data:image/png;base64,\" />"
                + "</div><div><p class=\"ql-indent-1\">Padding Silvia</p><p>Sin padding</p></div></body></html>";
        
        String inputfilepath = "E:\\SES\\Documentación facilitada por IPSS\\INFORMES\\informe.html";
        
        // WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage.createPackage();
        // AlternativeFormatInputPart afiPart = new AlternativeFormatInputPart(new PartName("/hw.html"));
        // afiPart.setBinaryData(limpiarHtml(html).getBytes());
        ...
        //
        // wordMLPackage.getMainDocumentPart().getContent().addAll(xhtmlImporter.convert(new File(inputfilepath),
        // null));
        //
        // wordMLPackage.save(file);
    }
    
    public void createPDFtoDoc() throws IOException {
        
        System.out.println("*****************inicio pdf to doc*********************");
        
        // Create the word document
        XWPFDocument doc = new XWPFDocument();
        
        // Open the pdf file
        String pdf = "C:\\informes\\informe.pdf";
        String docxFile = "C:\\informes\\informe.docx";
        ...
        System.out.println("*****************fin pdf to doc*********************");
    }
}