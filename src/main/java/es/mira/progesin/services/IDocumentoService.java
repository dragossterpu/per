...
public interface IDocumentoService {
  ...
  /**
   * Elimina una serie de documentos de la base de datos. El documento a eliminar se pasa como
   * parámetro.
   * 
  ...
  /**
   * Guarda un documento en base de datos. Como parámetro recibe el documento a guardar y devuelve
  ...
  /**
   * Recibe un archivo UploadedFile del que recupera los datos para generar un Documento que se
   * almacenará en base de datos. Devuelve el documento almacenado.
   * 
   * 
  ...
  /**
   * Recibe un archivo UploadedFile y los datos necesarios para general un Documento pero no lo
   * almacena en base de datos. Sólo deja el objeto preparado para guardarlo.
   * 
   * @param file fichero a cargar en BDD
   * @param tipo tipo de documentp
   * @param inspeccion inspección asociada al documento
  ...
  /**
   * Devuelve el id de la solicitud de documentación que tiene asociado el documento pasado como
   * parámetro.
   * 
