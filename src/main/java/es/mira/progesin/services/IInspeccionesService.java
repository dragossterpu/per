...
public interface IInspeccionesService {
  ...
  /**
   * Busca inspecciones no finalizadas filtrando por el nombre de la unidad o el número de la
   * inspección.
   * 
   * @param infoInspeccion nombre de la unidad o número de inspección
   * @return devuelve una lista con todas las inspecciones filtradas indicando el nombre de la
   * unidad o el número de inspección
   */
   ...
   * @return devuelve una lista con todas las inspecciones filtradas por nombre de la unidad y jefe
   * de equiopo o por el número de inspección y el jefe de equipo
   */
  ...
  /**
   * Método que realiza una consulta de inspecciones, usando criteria, coincidente con determinados
   * parámetros.
   * 
   ...
   */
  List<Inspeccion> buscarInspeccionPorCriteria(int first, int pageSize, String sortField,
      SortOrder sortOrder, InspeccionBusqueda busqueda);
