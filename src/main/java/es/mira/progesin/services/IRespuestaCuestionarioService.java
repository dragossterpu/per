...
public interface IRespuestaCuestionarioService {
   ...
   */
  RespuestaCuestionario saveConDocumento(RespuestaCuestionario respuestaCuestionario,
      UploadedFile file) throws ProgesinException;
   ...
   * @return respuesta actualizada
   */
  RespuestaCuestionario eliminarDocumentoRespuesta(RespuestaCuestionario respueta,
      Documento documento);
}
