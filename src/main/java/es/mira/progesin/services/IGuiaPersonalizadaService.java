...
public interface IGuiaPersonalizadaService {
  ...
  /**
   * Devuelve el número de registros de la base de datos que cumplen con los criterio pasados como
   * parámetro.
   * 
  ...
  /**
   * Busca en base de datos los resultados que se ajustan a los parámetros recibidos en el objeto de
   * tipo GuiaPersonalizadaBusqueda acotados por los parámetros first (primer resultado) y pageSize
   * (máximo de resultados de la búsqueda).
   * 
   ...
   * 
   */
  List<GuiaPersonalizada> buscarGuiaPorCriteria(int first, int pageSize, String sortField,
      SortOrder sortOrder, GuiaBusqueda busqueda);

  /**
   * Comprueba la existencia en base de datos de guías personalizadas cuya guía modelo corresponde a
