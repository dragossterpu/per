...
public interface IConfiguracionRespuestasCuestionarioRepository
     ...
     * @return lista de configuraciones
     */
    @Query("select c from ConfiguracionRespuestasCuestionario c where c.config.seccion = :seccion and c.config.clave not like 'nombreFila%' order by c.config.clave asc")
     ...
     * @return lista de configuraciones
     */
    @Query("select c from ConfiguracionRespuestasCuestionario c where c.config.seccion = :seccion and c.config.clave like 'nombreFila%' order by c.config.clave asc")
