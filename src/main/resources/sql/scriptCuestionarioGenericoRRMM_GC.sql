...
--Insert modelo
insert into MODELOSCUESTIONARIOS (ID,CODIGO,DESCRIPCION,FECHA_ALTA,USERNAME_ALTA,ESTANDAR)  values (SEQ_MODELOSCUESTIONARIOS.NEXTVAL,'GC_RRMM','CUESTIONARIO GENÉRICO (GUARDIA CIVIL) DE RECURSOS MATERIALES', sysdate, 'system',1);
