...
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Actas de las Comisiones Provinciales de Seguridad Privada de los años 2014 y 2015', 'ACPSP', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Actas de las Comisiones de Coordinación de Policía Judicial de los años 2014 y 2015', 'ACCPJ', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Actas de las Juntas Locales de Seguridad de los años 2014 y 2015', 'AJLS', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Actas de las Juntas de Coordinación de 2015', 'AJC', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Catálogo de Puestos de Trabajo (última aprobación CECIR) y fuerza en revista', 'CPT', 'XLSX');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Convenios de colaboración con Policías Locales (tanto genéricos como específicos)', 'CCPL', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Copia de las actas de las reuniones sindicales celebradas en 2014 y 2015', 'CAS', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Documentación relativa al Plan Territorial. Objetivos operativos fijados para 2015', 'PTyO', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Evaluación de Riesgos Laborales', 'PRL', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Libro de Organización y Libro de Normas de Régimen Interno', 'LOYRI', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Mapa con la distribución territorial de sus Unidades subordinadas.', 'mapa', 'JPG, JPEG, PNG, BMP');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Memoria Anual de 2015', 'MA', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Organigrama de la Comandancia (Unidades Territoriales y Especialidades)', 'organigrama', 'DOC, DOCX, PPTX, PPT, PUB');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Organigrama de la Zona (Unidades Territoriales y Especialidades)', 'organigrama', 'DOC, DOCX, PPTX, PPT, PUB');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Organigramas de la Unidad, con detalle de sus Unidades y Servicios', 'organigrama', 'DOC, DOCX, PPTX, PPT, PUB');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Plan anual de la Unidad Orgánica de Policía Judicial vigente', 'PAUOPJ', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Plan de Emergencia', 'PE', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Plan de Seguridad Ciudadana', 'PSC', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Relación de mandos de las distintas Unidades, de categoría Oficial, con indicación de teléfonos y correos electrónicos de contacto', 'RM', 'PDF');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Relación de municipios que configuran la demarcación de la compañía', 'RMD', 'DOC, DOCX');
Insert into  tipodocumentacionprevia (ID,DESCRIPCION,NOMBRE,EXTENSIONES) Values (nextval('seq_tipodocumentacionprevia'), 'Relación del Equipo Directivo con indicación del nombre y apellidos, categoría y cargo, números de teléfono y dirección de correo electrónico', 'RM', 'DOC, DOCX');
