...
insert into areas_informe(id, descripcion, modelo_informe) values (1, '1.- INTRODUCCIÓN', 1);
insert into subareas_informe(id, descripcion, area_id) values (1, '1.1.- Introducción.', 1);

insert into areas_informe(id, descripcion, modelo_informe) values (2, '2.- ÁMBITO Y OBJETIVOS DE LA INSPECCIÓN', 1);
...
insert into areas_informe(id, descripcion, modelo_informe) values (3, '3.- REUNIONES Y VISITAS INSTITUCIONALES', 1);
...
insert into areas_informe(id, descripcion, modelo_informe) values (4, '4.- INFRAESTRUCTURAS E INSTALACIONES', 1);
...
insert into areas_informe(id, descripcion, modelo_informe) values (5, '5.- DOTACIÓN Y GESTIÓN DE RECURSOS HUMANOS', 1);
...
insert into areas_informe(id, descripcion, modelo_informe) values (6, '6.- DOTACIÓN Y GESTIÓN DE RECURSOS MATERIALES', 1);
...
insert into areas_informe(id, descripcion, modelo_informe) values (7, '7.- ÁREAS ADMINISTRATIVAS Y DE APOYO', 1);
...
insert into areas_informe(id, descripcion, modelo_informe) values (8, '8.- ÁREA OPERATIVA', 1);
...
insert into areas_informe(id, descripcion, modelo_informe) values (9, '9.- LIBROS OFICIALES', 1);
...
insert into areas_informe(id, descripcion, modelo_informe) values (10, '10.- PROGRAMA ESTADÍSTICO DE SEGURIDAD', 1);
