...
'Organización, estructura, funciones y competencias del Servicio de Prevención.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 0);
...
así como personal de apoyo y auxiliar, con expresión de Orden y fecha de creación de la Unidad (Sección/Oficina)', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 1);
...
copia de la documentación acreditativa relativa a la formación y calibración de los equipos.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 2);
...
insert into  preguntascuestionario (id, pregunta, id_area, tipo_respuesta, orden) values (SEQ_PREGUNTASCUESTIONARIO.NEXTVAL, 'Planes de Zona, elaborados por las Secciones y fecha de aprobación por el Director General de la Guardia Civil. .', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 1);
...
otras circunstancias que exijan una revisión y actualización).', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 2);
...
(Unidades especializadas).', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 3);
...
'Actividades de seguimiento y control de las acciones correctoras', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 4);
...
'Planes de Emergencia/Autoprotección elaborados durante el periodo, diferenciando los llevados a cabo por el Servicio de Prevención, Secciones y Oficinas', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 5);

insert into  preguntascuestionario (id, pregunta, id_area, tipo_respuesta, orden) values (SEQ_PREGUNTASCUESTIONARIO.NEXTVAL, 'Planes de Emergencia y de Autoprotección.' || chr(13) || chr(10) ||
'Relación de los que quedan pendientes de realizar', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 6);

insert into  preguntascuestionario (id, pregunta, id_area, tipo_respuesta, orden) values (SEQ_PREGUNTASCUESTIONARIO.NEXTVAL, 'Planes de Emergencia y de Autoprotección.' || chr(13) || chr(10) ||
'Indicar simulacros realizados.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 7);
...
relación con los riesgos derivados del ejercicio de las funciones profesionales', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 8);
...
al estado psicofísico del funcionario.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 9);

insert into  preguntascuestionario (id, pregunta, id_area, tipo_respuesta, orden) values (SEQ_PREGUNTASCUESTIONARIO.NEXTVAL, 'Vigilancia de la Salud. Coordinación con los Servicios de Asistencia Sanitaria y de Psicología y Psicotecnia.' || chr(13) || chr(10) || 
'Actuaciones llevadas a acabo en relación a la protección de la guardia civil en situación de embarazo, parto reciente o en periodo de lactancia.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 10);
...
'Relación de accidentes de trabajo con indicación de mortales, graves y leves.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 11);
...
notificación e investigación.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 12);
...
insert into  preguntascuestionario (id, pregunta, id_area, tipo_respuesta, orden) values (SEQ_PREGUNTASCUESTIONARIO.NEXTVAL, 'Estudio y Análisis de los Accidentes Ocurridos en Actos de Servicio.' || chr(13) || chr(10) ||
'Medidas preventivas de las propuestas en el informe de investigación INVAS23/13-SP adoptadas y, en su caso, situación en qué se encuentren las pendiente.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 14);
...
'Manuales, Campañas de Prevención, Trípticos y cualquier otro medio informativo. Procedimiento empleado para justificar la recepción por el personal.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'ADJUNTOINPUT', 17);
...
De cada una de las actividades se realizará una breve descripción que al menos contenga:' || chr(13) || chr(10) || 
...
laborales en el ámbito de la Dirección General de la Guardia Civil.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 21);
...
Número y tipos de actuaciones en esta materia llevadas a cabo por el Servicio de Prevención.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 23);
...
'Relación detallada de la documentación correspondiente a la actividad desplegada en el ámbito de la Dirección General de la Guardia Civil en materia de prevención de riesgos laborales, que se encuentra bajo la custodia y archivo de ese Servicio de Prevención.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 25);
...
'Papel desempeñado por el Servicio de Prevención en el Protocolo de Acoso.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 27);
...
y sugerencias en materia de prevención, recibidas en el Servicio de Prevención.', SEQ_AREASCUESTIONARIOS.CURRVAL, 'TEXTAREA', 28);
