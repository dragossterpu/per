...
Insert into MODELOSCUESTIONARIOS (ID,CODIGO,DESCRIPCION,FECHA_ALTA,USERNAME_ALTA,ESTANDAR) values (SEQ_MODELOSCUESTIONARIOS.NEXTVAL,'AMBITO_PN','ÁMBITO DE LA INSPECCIÓN DE LA POLICIA NACIONAL', sysdate, 'system',1);
...
Insert into MODELOSCUESTIONARIOS (ID,CODIGO,DESCRIPCION,FECHA_ALTA,USERNAME_ALTA,ESTANDAR) values (SEQ_MODELOSCUESTIONARIOS.NEXTVAL,'AMBITO_GC','ÁMBITO DE LA INSPECCIÓN DE LA GUARDIA CIVIL', sysdate, 'system',1);
