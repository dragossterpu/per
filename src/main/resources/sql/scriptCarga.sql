...
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE) values ('cfrutosc','DE FRUTOS','CABRERO','cfrutosc@interior.es',17,'A1',144,'ACTIVO',sysdate,to_timestamp('01/01/2000','DD/MM/RR'),27,'CARLOS','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372513','system',2,4,7,6,1);
...
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE) values ('jmirandap','MIRANDA','PEÑAS','jmiranda@interior.es',30,'A1',170,'ACTIVO',sysdate,to_timestamp('01/01/2000','DD/MM/RR'),27,'JAVIER','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372514','system',1,4,21,6,1);
