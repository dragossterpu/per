...
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('mbotas','DOMÍNGUEZ','BOTAS','mbotas@interior.es','24279073-C','C1',159,'ACTIVO',sysdate,to_timestamp('03/02/2017','DD/MM/RR'),18,'MARTA','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372626','system',1,8,24,9,1,to_timestamp('01/02/2007','DD/MM/RR'));
