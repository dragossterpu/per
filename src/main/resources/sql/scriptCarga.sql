...
BEGIN
	...
	EXECUTE IMMEDIATE 'DROP SEQUENCE "SEQ_MUNICIPIO"';
...
BEGIN
	...
	EXECUTE IMMEDIATE 'DROP TABLE "DOCUMENTOS_INSPECCION" CASCADE CONSTRAINTS';
	...
	EXECUTE IMMEDIATE 'DROP TABLE "INSPECCIONES_ASOCIADAS" CASCADE CONSTRAINTS';
	...
	EXECUTE IMMEDIATE 'DROP TABLE "TIPOS_UNIDAD" CASCADE CONSTRAINTS';
...
prompt =========================================================================
prompt  Creacion índice  UK_DMN5WGHM1FFRHM17PP80KRJR8
prompt =========================================================================

  CREATE UNIQUE INDEX "UK_DMN5WGHM1FFRHM17PP80KRJR8" ON "RESPUESTAS_CUEST_DOCS" ("ID_DOCUMENTO");
/
prompt =========================================================================
prompt  Creacion índice  UK_A6Q8QOKKA9KUEDJ5EF52P602K
prompt =========================================================================

  CREATE UNIQUE INDEX "UK_A6Q8QOKKA9KUEDJ5EF52P602K" ON "TIPO_EQUIPO" ("CODIGO");
/
prompt =========================================================================
...
prompt =========================================================================
  ...
  ALTER TABLE "TIPO_EQUIPO" ADD CONSTRAINT "UK_A6Q8QOKKA9KUEDJ5EF52P602K" UNIQUE ("CODIGO")
  USING INDEX  ENABLE;
...
prompt =========================================================================
  ...
  ALTER TABLE "RESPUESTAS_CUEST_DOCS" ADD CONSTRAINT "UK_DMN5WGHM1FFRHM17PP80KRJR8" UNIQUE ("ID_DOCUMENTO")
  USING INDEX  ENABLE;
...
prompt =========================================================================
  ...
  ALTER TABLE "AREASCUESTIONARIO" ADD CONSTRAINT "FKQRPJDJNR7QQUUE5PSDF1DRD48" FOREIGN KEY ("ID_CUESTIONARIO")
...
prompt =========================================================================
  ...
  ALTER TABLE "CUEST_PER_PREGUNTAS" ADD CONSTRAINT "FKCV4C4VYK4B2T2KW9LBNORC3FN" FOREIGN KEY ("ID_PREG_ELEGIDA")
	  REFERENCES "PREGUNTASCUESTIONARIO" ("ID") ENABLE;
  ALTER TABLE "CUEST_PER_PREGUNTAS" ADD CONSTRAINT "FKIKRWBOHG0LM7P4WYD0Q0WLVBB" FOREIGN KEY ("ID_CUEST_PERS")
	  REFERENCES "CUESTIONARIO_PERSONALIZADO" ("ID") ENABLE;
/
prompt =========================================================================
...
prompt =========================================================================
  ...
  ALTER TABLE "DOCUMENTOS" ADD CONSTRAINT "FKSH06P1MA9PC9A7V9GJDMRJE2" FOREIGN KEY ("TIPO_DOCUMENTO")
...
prompt =========================================================================
  ...
  ALTER TABLE "DOCUMENTOS_INSPECCION" ADD CONSTRAINT "FKHED7HT43X8V692UBEF98DJC0V" FOREIGN KEY ("ID_INSPECCION")
	  REFERENCES "INSPECCIONES" ("ID") ENABLE;
  ALTER TABLE "DOCUMENTOS_INSPECCION" ADD CONSTRAINT "FKSI5XA2IMKTCOVTUNSMAC1LGRU" FOREIGN KEY ("ID_DOCUMENTO")
...
prompt =========================================================================
  ...
  ALTER TABLE "GUIA_PERSONALIZADA_PASOS" ADD CONSTRAINT "FK6E5YOV30IGH3BOWTR6T9LTIOS" FOREIGN KEY ("ID_PASO_ELEGIDO")
	  REFERENCES "GUIA_PASOS" ("ID") ENABLE;
  ALTER TABLE "GUIA_PERSONALIZADA_PASOS" ADD CONSTRAINT "FKH1RDFT2YWU76CGFAIOQBBST5U" FOREIGN KEY ("ID_GUIA_PERS")
...
prompt =========================================================================
  ...
  ALTER TABLE "INSPECCIONES_ASOCIADAS" ADD CONSTRAINT "FKDVN231I93PPE3HVET0ACOL6HA" FOREIGN KEY ("ID_INSPECCION_ASOCIADA")
	  REFERENCES "INSPECCIONES" ("ID") ENABLE;
  ALTER TABLE "INSPECCIONES_ASOCIADAS" ADD CONSTRAINT "FKS08BPWCJ159UJFJMC0C54R0OF" FOREIGN KEY ("ID_INSPECCION")
	  REFERENCES "INSPECCIONES" ("ID") ENABLE;
/
prompt =========================================================================
...
prompt =========================================================================
  ...
  ALTER TABLE "RESPUESTA_DATOS_TABLA" ADD CONSTRAINT "FKPF7095T1DHM3R0SYCU0IAVDG1" FOREIGN KEY ("RESPUESTA_ID_CUEST_ENVIADO", "RESPUESTA_ID_PREGUNTA")
...
prompt =========================================================================
  ...
  ALTER TABLE "RESPUESTAS_CUEST_DOCS" ADD CONSTRAINT "FK6MCWE20DXDEBU9K92LQ6JWE50" FOREIGN KEY ("ID_CUESTIONARIO_ENVIADO", "ID_PREGUNTA")
	  REFERENCES "RESPUESTASCUESTIONARIO" ("ID_CUEST_ENVIADO", "ID_PREGUNTA") ENABLE;
  ALTER TABLE "RESPUESTAS_CUEST_DOCS" ADD CONSTRAINT "FK8H6G5RGURJT87SKVJ8IAP43D4" FOREIGN KEY ("ID_DOCUMENTO")
	  REFERENCES "DOCUMENTOS" ("ID") ENABLE;
/
prompt =========================================================================
...
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('1',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Subdirección General de Inspección y Servicios');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('2',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Secretaría Técnica');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('3',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Jefatura de Inspecciones');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('4',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Equipos de Inspecciones Generales');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('5',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Equipo de Inspecciones Temáticas y PRL');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('6',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Gabinete de Estudios y Análisis');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('7',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Servicio de Calidad y Quejas');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('8',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Servicio de Apoyo');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('9',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Secretaría');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('10',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Asesores');
Insert into DEPARTAMENTO (ID,FECHA_ALTA,FECHA_BAJA,FECHA_MODIFICACION,USERNAME_ALTA,USERNAME_BAJA,USERNAME_MODIF,DESCRIPCION) values ('11',to_timestamp('08/05/17 14:56:52,000000000','DD/MM/RR HH24:MI:SS,FF'),null,null,'system',null,null,'Conductores');
COMMIT;
...
begin
  ...
  EXECUTE IMMEDIATE 'CREATE SEQUENCE  "SEQ_TIPODOCUMENTACIONPREVIA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION' ;
