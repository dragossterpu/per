...
begin
  ...
  EXECUTE IMMEDIATE 'CREATE SEQUENCE  SEQ_CLASE  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY ' || maximo || '  START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION' ;
  
  select max(id)+1 into maximo from DEPARTAMENTO;
  EXECUTE IMMEDIATE 'CREATE SEQUENCE  SEQ_DEPARTAMENTO  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY ' || maximo || '  START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION' ;
