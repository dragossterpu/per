...
prompt
prompt    Actualización:  11/12/2017   
prompt =========================================================================
...
CREATE TABLE PROGESIN_SYS.AREASCUESTIONARIO 
   (    ID NUMBER(19,0) NOT NULL ENABLE, 
    NOMBRE_AREA VARCHAR2(2000 CHAR) NOT NULL ENABLE, 
    FECHA_BAJA TIMESTAMP (6), 
...
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (1,'GC','Actas de las Comisiones Provinciales de Seguridad Privada de los dos últimos años y año en curso','PDF','AC_seguridad_privada');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (2,'PN','Actas de las Comisiones Provinciales de Seguridad Privada de los dos últimos años y año en curso','PDF','AC_seguridad_privada');
...
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (5,'GC','Actas de las Juntas Locales de Seguridad de los dos últimos años y año en curso','PDF','AJ_locales_seguridad');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (6,'PN','Actas de las Juntas Locales de Seguridad de los dos últimos años y año en curso','PDF','AJ_locales_seguridad');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (7,'GC','Actas de las Juntas de Coordinación de la comandancia de los dos últimos años y año en curso','PDF','AJ_coordinacion');
...
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (9,'GC','Convenios de colaboración con Policías Locales (tanto genéricos como específicos) (VIOGEN, POLICÍA JUDICIAL, SEGURIDAD CIUDADANA)…','PDF','CC_policias_locales');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (10,'PN','Convenios de colaboración con Policías Locales (tanto genéricos como específicos) (VIOGEN, POLICÍA JUDICIAL, SEGURIDAD CIUDADANA)…','PDF','CC_policias_locales');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (11,'GC','Convenios de colaboración con Instituciones y Organismos','PDF','CC_instituciones_organ');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (12,'PN','Convenios de colaboración con Instituciones y Organismos','PDF','CC_instituciones_organ');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (13,'GC','Otros convenios de colaboración con instituciones y organismos. Incluir protocolos, acuerdos, etc.','PDF','Convenios_protocolos');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (14,'PN','Otros convenios de colaboración con instituciones y organismos. Incluir protocolos, acuerdos, etc.','PDF','Convenios_protocolos');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (15,'GC','Actas de las reuniones sindicales / asociaciones profesionales celebradas en los dos últimos años y año en curso','PDF','A_reunion_sindical_asociativa');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (16,'PN','Actas de las reuniones sindicales / asociaciones profesionales celebradas en los dos últimos años y año en curso','PDF','A_reunion_sindical_asociativa');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (17,'PN','Documentación relativa al Plan Territorial. Objetivos operativos fijados para el año en curso y el anterior','PDF','Plan_territorial');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (18,'GC','Evaluación de Riesgos Laborales','PDF','Eval_riesgos_laborales');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (19,'PN','Evaluación de Riesgos Laborales','PDF','Eval_riesgos_laborales');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (20,'GC','Libro de Organización y Libro de Normas de Régimen Interior','PDF','Libro_org_libro_normas');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (21,'GC','Mapa con la distribución territorial de sus Unidades subordinadas','JPG, JPEG, PNG, BMP','Mapa');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (22,'PN','Mapa con la distribución territorial de sus Unidades subordinadas','JPG, JPEG, PNG, BMP','Mapa');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (23,'GC','Memoria Anual de los dos últimos años','PDF','Memoria_anual');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (24,'PN','Memoria Anual de los dos últimos años','PDF','Memoria_anual');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (25,'GC','Organigramas de la Unidad inspeccionada, con detalle de las unidades, grupos, servicios y especialidades','DOC, DOCX, PPTX, PPT, PUB','Organigrama');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (26,'PN','Organigramas de la Unidad inspeccionada, con detalle de las unidades, grupos, servicios y especialidades','DOC, DOCX, PPTX, PPT, PUB','Organigrama');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (27,'GC','Plan anual vigente de la Unidad Orgánica de Policía Judicial, SEPRONA y otras especialidades que lo confeccionen','PDF','Plan_anual_especialidades');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (28,'GC','Plan de Emergencia','PDF','Plan_emergencia');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (29,'PN','Plan de Emergencia','PDF','Plan_emergencia');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (30,'GC','Plan de Seguridad Ciudadana','PDF','Plan_seguridad_ciudanada');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (31,'GC','Relación de mandos de la jefatura y de las distintas Unidades con indicación de teléfonos y correos electrónicos de contacto','DOC, DOCX, PDF','Relacion_mandos');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (32,'GC','Relación de Núcleos Operativos constituidos. Puestos integrados en los mismos, con detalle de sus municipios, población y superficie','DOC, DOCX','Relac_nucleos_op_puestos');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (33,'PN','Relación del Equipo Directivo con indicación del nombre y apellidos, categoría y cargo, números de teléfono y dirección de correo electrónico','DOC, DOCX','Relacion_eq_directivo');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (34,'GC','Catálogo de puestos de trabajo Comandancia','XLSX','00_d_CPT_C');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (35,'GC','Catálogo de puestos de trabajo Compañía','XLSX','00_d_CPT_CIA');
Insert into TIPODOCUMENTACIONPREVIA (ID,AMBITO,DESCRIPCION,EXTENSIONES,NOMBRE) values (36,'GC','Catálogo de puestos de trabajo Zona','XLSX','00_d_CPT_Z');
...
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('manogal','NOGAL','GOMEZ','manogal@interior.es','12705614-T','A1',123,'ACTIVO',sysdate,to_timestamp('19/03/2017','DD/MM/RR'),30,'MIGUEL ANGEL ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_ADMIN','915372608','system',1,1,18,1,1,to_timestamp('09/09/1974','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jldominguez','DOMINGUEZ','ALONSO','jldominguez@interior.es','12314044-M','A1',117,'ACTIVO',sysdate,to_timestamp('12/01/2015','DD/MM/RR'),29,'JOSE LUIS','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_JEFE_INSPECCIONES','915372628','system',1,3,18,2,1,to_timestamp('17/09/1973','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('ccasilla','CASILLAS ','CASILLAS','ccasilla@interior.es','06526962-E','A1',111,'ACTIVO',sysdate,to_timestamp('19/02/2007','DD/MM/RR'),28,'CASIMIRO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372546','system',1,4,18,5,1,to_timestamp('01/06/1977','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('fjimenezm','JIMENEZ','MESA','fjimenezm@interior.es','21958097-C','A1',115,'ACTIVO',sysdate,to_timestamp('18/07/2012','DD/MM/RR'),28,'FRANCISCO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372558','system',2,4,4,5,1,to_timestamp('10/07/1973','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('mmesa','MESA','HERRERUELA','mmesa@interior.es','02503279-M','A1',124,'ACTIVO',sysdate,to_timestamp('15/02/1999','DD/MM/RR'),28,'MANUEL','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915332633','system',2,4,5,5,1,to_timestamp('01/09/1975','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('ariesco','RIESCO','SOBRÉ','ariesco@interior.es','41076632-N','A1',131,'ACTIVO',sysdate,to_timestamp('17/04/2015','DD/MM/RR'),28,'ANGEL','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372517','system',1,5,18,5,1,to_timestamp('01/02/1979','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('rroman','ROMAN','MARTÍN-CONSUEGRA','rroman@interior.es','56181161-C','A1',113,'ACTIVO',sysdate,to_timestamp('02/01/2014','DD/MM/RR'),28,'RAMON','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372533','system',1,4,18,5,1,to_timestamp('15/10/1975','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jsuarez','LOSADA','SUÁREZ','jsuarez@interior.es','15348196-C','A1',129,'ACTIVO',sysdate,to_timestamp('29/03/2016','DD/MM/RR'),28,'JULIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372620','system',1,4,19,5,1,to_timestamp('09/09/1974','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('josess','SAN SEGUNDO','CORCHERO','josess@interior.es','12245323-P','A1',135,'ACTIVO',sysdate,to_timestamp('02/08/2005','DD/MM/RR'),28,'JOSÉ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372553','system',2,4,5,5,1,to_timestamp('01/03/1978','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('mmdeantonio','ANTONIO','ANTOLÍN','mmdeantonio@interior.es','03433263-F','A1',171,'ACTIVO',sysdate,to_timestamp('30/07/2015','DD/MM/RR'),27,'MARIA MERCEDES','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372584','system',1,4,20,6,1,to_timestamp('01/09/1981','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('alvarado','ALVARADO','BALLESTEROS','alvarado@interior.es','50046690-R','A1',140,'ACTIVO',sysdate,to_timestamp('29/07/2010','DD/MM/RR'),27,'MARIA PILAR','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372605','system',1,4,20,6,1,to_timestamp('01/12/1982','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jbarba','BARBA','CEREZO','jbarba@interior.es','06948674-Y','A1',146,'ACTIVO',sysdate,to_timestamp('07/03/1997','DD/MM/RR'),27,'JOSÉ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372617','system',2,4,7,6,1,to_timestamp('01/09/1975','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('fernanc','CALATAYUD','DE LA HOZ','fernanc@interior.es','01491655-J','A1',142,'ACTIVO',sysdate,to_timestamp('15/12/2009','DD/MM/RR'),27,'FERNANDO E. ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372619','system',1,4,20,6,1,to_timestamp('21/10/1978','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jcoronel','CORONEL','RODRÍGUEZ','jcoronel@interior.es','01815115-R','A1',150,'ACTIVO',sysdate,to_timestamp('18/05/2006','DD/MM/RR'),27,'JUAN FRANCISCO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372552','system',1,4,20,6,1,to_timestamp('01/03/1984','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('mdominguez','DOMÍNGUEZ','ROCA','mdominguez@interior.es','33279818-Z','A1',192,'ACTIVO',sysdate,to_timestamp('23/03/2015','DD/MM/RR'),27,'MARÍA','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372624','system',2,4,8,6,1,to_timestamp('17/09/1995','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jbastida','ESPERANZA','BASTIDA','jbastida@interior.es','686203-K','A1',169,'ACTIVO',sysdate,to_timestamp('01/08/2005','DD/MM/RR'),27,'JUAN JOSÉ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372616','system',2,4,6,6,1,to_timestamp('10/02/1979','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('cfrutosc','FRUTOS','CABRERO','cfrutosc@interior.es','15841435-R','A1',144,'ACTIVO',sysdate,to_timestamp('01/06/2007','DD/MM/RR'),27,'CARLOS DE','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372513','system',2,4,7,6,1,to_timestamp('01/09/1979','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('ggarrido','GARRIDO','MAZOTERAS','ggarrido@interior.es','51664677-F','A1',148,'ACTIVO',sysdate,to_timestamp('21/01/2014','DD/MM/RR'),27,'GUSTAVO A. ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372613','system',1,4,21,6,1,to_timestamp('01/09/1996','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('fgonzale','GONZÁLEZ','LLANTADA','fgonzale@interior.es','50414917-K','A1',172,'ACTIVO',sysdate,to_timestamp('27/08/2007','DD/MM/RR'),27,'FRANCISCO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372618','system',1,4,20,6,1,to_timestamp('01/10/1980','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('sgutierrez','GUTÍERREZ','PÉREZ','sgutierrez@interior.es','01113325-X','A1',155,'ACTIVO',sysdate,to_timestamp('06/11/2017','DD/MM/RR'),27,'SANTOS','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372659','system',2,4,7,6,1,to_timestamp('01/09/1981','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jmjimene','JIMENEZ','NARROS','jmjimene@interior.es','51642061-T','A1',166,'ACTIVO',sysdate,to_timestamp('01/06/2007','DD/MM/RR'),27,'JOSE MANUEL','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372575','system',3,4,6,6,1,to_timestamp('01/09/1990','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jlealp','LEAL','PEREZ-OLAGÜE','jlealp@interior.es','51056588-S','A1',198,'ACTIVO',sysdate,to_timestamp('21/07/2015','DD/MM/RR'),27,'JAVIER','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372512','system',1,4,20,6,1,to_timestamp('01/10/1980','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('xalopez','LOPEZ','FERNANDEZ','xalopez@interior.es','34908986-T','A1',137,'ACTIVO',sysdate,to_timestamp('02/08/2005','DD/MM/RR'),27,'JOSE ANTONIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372575','system',2,4,6,6,1,to_timestamp('01/09/1975','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('llorente','LLORENTE','BARRETO','llorente@interior.es','03468147-T','A1',167,'ACTIVO',sysdate,to_timestamp('20/06/2011','DD/MM/RR'),27,'JUAN','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372528','system',2,4,8,6,1,to_timestamp('12/11/1994','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('bmarting','MARTÍN','GARCÍA','bmarting@interior.es','416617-H','A1',191,'ACTIVO',sysdate,to_timestamp('29/05/2015','DD/MM/RR'),27,'BENIGNO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372629','system',2,4,7,6,1,to_timestamp('06/05/1985','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('rmartinp','MARTÍN-POZUELO','LÓPEZ','rmartinp@interior.es','51636008-L','A1',154,'ACTIVO',sysdate,to_timestamp('23/07/2008','DD/MM/RR'),27,'RAFAEL','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372551','system',2,4,7,6,1,to_timestamp('01/03/1983','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('fmfernandez','MARTINEZ','FERNANDEZ','fmfernandez@interior.es','05360198-W','A1',147,'ACTIVO',sysdate,to_timestamp('03/12/2012','DD/MM/RR'),27,'FERNANDO  ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372627','system',2,4,7,6,1,to_timestamp('15/02/1977','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('rmartine','MARTÍNEZ ','ORTEGA','rmartine@interior.es','02845098-K','A1',190,'ACTIVO',sysdate,to_timestamp('10/05/2007','DD/MM/RR'),27,'ROGELIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372653','system',1,4,22,6,1,to_timestamp('01/11/1983','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('rjmartinez','MARTÍNEZ ','SERRANO','rjmartinez@interior.es','06566392-F','A1',171,'ACTIVO',sysdate,to_timestamp('23/01/2013','DD/MM/RR'),27,'RAFAEL JESÚS','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372652','system',2,4,7,6,1,to_timestamp('02/09/1991','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jmiranda','MIRANDA','PEÑAS','jmiranda@interior.es','02230771-R','A1',170,'ACTIVO',sysdate,to_timestamp('23/07/2008','DD/MM/RR'),27,'JAVIER','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372514','system',1,4,21,6,1,to_timestamp('08/09/1998','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('saturio','NIETO','GARRIDO','saturio@interior.es','07824516-P','A1',168,'ACTIVO',sysdate,to_timestamp('05/05/1998','DD/MM/RR'),27,'SATURIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372523','system',1,4,20,6,1,to_timestamp('22/04/1982','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('mortegam','ORTEGA','MEDINA','mortegam@interior.es','25993045-D','A1',152,'ACTIVO',sysdate,to_timestamp('31/05/2007','DD/MM/RR'),27,'MARTIN','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372545','system',2,4,7,6,1,to_timestamp('07/03/1983','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('ipascual','PASCUAL','CUEVAS','ipascual@interior.es','13066294-V','A1',157,'ACTIVO',sysdate,to_timestamp('03/01/2011','DD/MM/RR'),27,'IGNACIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372537','system',1,4,20,6,1,to_timestamp('01/07/1976','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('rmriera','RIERA','FERNÁNDEZ','rmriera@interior.es','10849720-E','A1',194,'ACTIVO',sysdate,to_timestamp('09/05/2016','DD/MM/RR'),27,'ROSA MARÍA','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372511','system',1,4,21,6,1,to_timestamp('14/09/1992','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('vromero','ROMERO','DE ANTONIO','vromero@interior.es','39677506-E','A1',153,'ACTIVO',sysdate,to_timestamp('26/08/2014','DD/MM/RR'),27,'VICTOR E. ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372617','system',2,4,7,6,1,to_timestamp('01/09/1983','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('agonzapa','GONZÁLEZ','PASTRANA','agonzapa@interior.es','09708337-Z','A1',143,'ACTIVO',sysdate,to_timestamp('01/06/2007','DD/MM/RR'),27,'ATANASIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_GABINETE','915372657','system',1,7,20,6,1,to_timestamp('05/09/1976','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('agmedina','GONZÁLEZ','MEDINA','agmedina@interior.es','50449125-M','A1',133,'ACTIVO',sysdate,to_timestamp('12/01/2009','DD/MM/RR'),27,'ANTONIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_GABINETE','915372535','system',2,7,6,6,1,to_timestamp('02/11/1997','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('tgarlito','GARLITO','DIAZ','tgarlito@interior.es','08764259-V','A1',197,'ACTIVO',sysdate,to_timestamp('01/06/2007','DD/MM/RR'),27,'TOMAS','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372656','system',2,5,6,6,1,to_timestamp('01/09/1973','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jchorche','HORCHE','DELGADO','jchorche@interior.es','02600528-X','A1',151,'ACTIVO',sysdate,to_timestamp('28/05/2007','DD/MM/RR'),27,'JUAN CARLOS','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372650','system',2,5,7,6,1,to_timestamp('15/09/1983','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jmmartin','MARTÍN','RUBIO','jmmartin@interior.es','17193630-A','A1',193,'ACTIVO',sysdate,to_timestamp('01/06/2002','DD/MM/RR'),27,'JUAN MANUEL','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372525','system',1,5,22,6,1,to_timestamp('27/09/1977','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jcperez','PEREZ','SIGLER','jcperez@interior.es','25559636-N','A1',196,'ACTIVO',sysdate,to_timestamp('18/07/1997','DD/MM/RR'),27,'JUAN CARLOS','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_EQUIPO_INSPECCIONES','915372587','system',1,5,20,6,1,to_timestamp('27/09/1977','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('mmayo','MAYO','RODRÍGUEZ','mmayo@interior.es','694184-K','A1',156,'ACTIVO',sysdate,to_timestamp('13/10/2015','DD/MM/RR'),27,'MANUEL','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372541','system',1,8,21,6,1,to_timestamp('01/03/1984','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('alvazquez','VAZQUEZ','RODRÍGUEZ','alvazquez@interior.es','03445444-K','A2',159,'ACTIVO',sysdate,to_timestamp('17/07/2009','DD/MM/RR'),21,'ALFREDO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372622','system',2,8,12,7,1,to_timestamp('01/05/1987','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('dtrujillos','TRUJILLO ','SILVEIRA','dtrujillos@interior.es','05239519-G','A2',159,'ACTIVO',sysdate,to_timestamp('18/08/2015','DD/MM/RR'),21,'DÁMASO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372632','system',2,8,12,7,1,to_timestamp('15/09/1982','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('magperez','GARCÍA','PÉREZ','magperez@interior.es','07533330W','C1',159,'ACTIVO',sysdate,to_timestamp('07/08/2007','DD/MM/RR'),18,'MIGUEL ANGEL ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372625','system',2,8,15,9,1,to_timestamp('07/09/1985','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('abarrena','BARRENA','ARTALEJO','abarrena@interior.es','02869657-Q','C1',159,'ACTIVO',sysdate,to_timestamp('05/06/2000','DD/MM/RR'),18,'ALFONSO CARLOS','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372607','system',2,8,17,9,1,to_timestamp('17/09/1984','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('sbastida','ESPERANZA','BASTIDA','sbastida@interior.es','52123135-Y','C1',159,'ACTIVO',sysdate,to_timestamp('27/04/2007','DD/MM/RR'),18,'JESÚS ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372565','system',2,8,17,9,1,to_timestamp('01/09/1988','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('mbotas','BOTAS','DOMÍNGUEZ','mbotas@interior.es','24279073-C','C1',159,'ACTIVO',sysdate,to_timestamp('03/02/2017','DD/MM/RR'),18,'MARTA','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372626','system',1,8,24,9,1,to_timestamp('01/02/2007','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('barjollo','BARJOLLO','MALDONADO','barjollo@interior.es','50742933-B','C1',159,'ACTIVO',sysdate,to_timestamp('25/04/2008','DD/MM/RR'),18,'FRANCISCO JAVIER','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372574','system',1,8,25,9,1,to_timestamp('04/09/2004','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('smiranda','MIRANDA','PEÑAS','smiranda@interior.es','02260311-D','C1',159,'ACTIVO',sysdate,to_timestamp('21/11/2017','DD/MM/RR'),18,'SUSANA','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372597','system',1,8,25,9,1,to_timestamp('06/09/2000','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('gromeral','ROMERAL','MARTÍNEZ','gromeral@interior.es','02230147-K','C1',132,'ACTIVO',sysdate,to_timestamp('01/07/2010','DD/MM/RR'),18,'GREGORIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372647','system',2,7,17,9,1,to_timestamp('06/05/1985','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('imartinb','MARTÍN','BARBERO','imartinb@interior.es','70864742-V','C1',132,'ACTIVO',sysdate,to_timestamp('17/05/2016','DD/MM/RR'),18,'IÑAKI','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_SERVICIO_APOYO','915372658','system',1,7,25,9,1,to_timestamp('10/09/2008','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('cirujano','CIRUJANO','RODRÍGUEZ','cirujano@interior.es','06209754-F','A1',136,'ACTIVO',sysdate,to_timestamp('02/08/2005','DD/MM/RR'),27,'FRANCISCO JAVIER ','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_GABINETE','915372549','system',1,6,20,6,1,to_timestamp('16/07/1979','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('jgarciab','GARCÍA','BORREGO','jgarciab@interior.es','816536-J','A1',138,'ACTIVO',sysdate,to_timestamp('25/05/2007','DD/MM/RR'),27,'JOSÉ ANTONIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_GABINETE','915372646','system',2,6,7,6,1,to_timestamp('01/10/1985','DD/MM/RR'));
Insert into USERS (USERNAME,PRIM_APELLIDO,SEGUNDO_APELLIDO,CORREO,DOC_IDENTIDAD,CATEGORIA,DESPACHO,ESTADO,FECHA_ALTA,FECHA_DESTINO_IPSS,NIVEL,NOMBRE,PASSWORD,ROLE,TELEFONO,USERNAME_ALTA,ID_CUERPO,ID_DEPARTAMENTO,ID_EMPLEO,ID_PUESTO,ID_CLASE, FECHA_INGRESO) values ('rherrera','HERRERA','ABIÁN','rherrera@interior.es','50170898-D','A1',192,'ACTIVO',sysdate,to_timestamp('01/06/2007','DD/MM/RR'),27,'ROSARIO','$2a$10$tDGyXBpEASeXlAUCdKsZ9u3MBBvT48xjA.v0lrDuRWlSZ6yfNsLve','ROLE_GABINETE','915372655','system',3,6,5,6,1,to_timestamp('01/09/1992','DD/MM/RR'));

Insert into EQUIPO (ID,FECHA_ALTA,USERNAME_ALTA,JEFE_EQUIPO,NOMBRE_EQUIPO,ID_TIPO_EQUIPO) values (seq_equipo.nextval,to_timestamp('21/09/2017','DD/MM/RR'),'system','josess','Equipo 1',2);

Insert into MIEMBROS (ID,POSICION,USUARIO,ID_EQUIPO) values (seq_miembros.nextval,'JEFE_EQUIPO','josess',seq_equipo.currval);
Insert into MIEMBROS (ID,POSICION,USUARIO,ID_EQUIPO) values (seq_miembros.nextval,'MIEMBRO','sgutierrez',seq_equipo.currval);
...
Insert into EQUIPO (ID,FECHA_ALTA,USERNAME_ALTA,JEFE_EQUIPO,NOMBRE_EQUIPO,ID_TIPO_EQUIPO) values (seq_equipo.nextval,to_timestamp('21/09/2017','DD/MM/RR'),'system','ccasilla','Equipo 2',2);
...
Insert into EQUIPO (ID,FECHA_ALTA,USERNAME_ALTA,JEFE_EQUIPO,NOMBRE_EQUIPO,ID_TIPO_EQUIPO) values (seq_equipo.nextval,to_timestamp('21/09/2017','DD/MM/RR'),'system','fjimenezm','Equipo 3',2);
...
Insert into EQUIPO (ID,FECHA_ALTA,USERNAME_ALTA,JEFE_EQUIPO,NOMBRE_EQUIPO,ID_TIPO_EQUIPO) values (seq_equipo.nextval,to_timestamp('21/09/2017','DD/MM/RR'),'system','mmesa','Equipo 4',2);
...
Insert into EQUIPO (ID,FECHA_ALTA,USERNAME_ALTA,JEFE_EQUIPO,NOMBRE_EQUIPO,ID_TIPO_EQUIPO) values (seq_equipo.nextval,to_timestamp('21/09/2017','DD/MM/RR'),'system','jsuarez','Equipo 5',2);
...
Insert into EQUIPO (ID,FECHA_ALTA,USERNAME_ALTA,JEFE_EQUIPO,NOMBRE_EQUIPO,ID_TIPO_EQUIPO) values (seq_equipo.nextval,to_timestamp('21/09/2017','DD/MM/RR'),'system','rroman','Equipo 6',2);
...
Insert into MIEMBROS (ID,POSICION,USUARIO,ID_EQUIPO) values (seq_miembros.nextval,'MIEMBRO','bmarting',seq_equipo.currval);
