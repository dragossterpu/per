...
PrimeFaces.locales['es'] = {
		...
		weekHeader: 'Semana', firstDay: 1, isRTL: false, showMonthAfterYear: false, yearSuffix: '', ampm: false,
		timeOnlyTitle: 'Sólo hora', timeText: 'Tiempo', hourText: 'Hora', minuteText: 'Minuto', secondText: 'Segundo', 
		currentText: 'Fecha actual', month: 'Mes', week: 'Semana', day: 'Día', allDayText : 'Todo el día' 
};